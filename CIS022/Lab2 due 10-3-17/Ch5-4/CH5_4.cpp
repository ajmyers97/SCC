...
int main(){
	...
	if (counter==3)
		cout<<"-";
if((startOrEnd='Y') || (startOrEnd='y')){
cout<<"The corresponding telephone number is:"<<endl;
	if((telephoneInLetters>='A' && telephoneInLetters<='Z') || (telephoneInLetters>='a' && telephoneInLetters<='z'))
		switch(telephoneInLetters){
         case 'A':
         case 'a':
         case 'B':
         case 'b':
