//Module:	CIS023_S2018_HW6 Allen Myers.cpp
//Project:	CIS023_S2018_HW6 Allen Myers
//Author:	Allen Myers
//Date:		March 10th, 2018
//Purpose:	Learn how to perform overloading of unary and mathematical operations on objects.
//			Practice using a combo - box.
//			Produce a project that uses exception handling.

#include "stdafx.h"
#include "CIS023_S2018_HW6 Allen Myers.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_CIS023_S2018_HW6ALLENMYERS, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_CIS023_S2018_HW6ALLENMYERS));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_CIS023_S2018_HW6ALLENMYERS));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_CIS023_S2018_HW6ALLENMYERS);
    ...
    case WM_COMMAND:
        {
			...
			case BN_CLICKED:											//button clicked
					...
					HIWORD(wParam) == CBN_SELCHANGE)					//selection changed
				{
					...
					HexClass numObjLeft(szInLeft);					//create object for left input
					HexClass numObjRight(szInRight);					//create object for right input
