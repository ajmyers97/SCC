//Module:	CIS023_S2018_Lab12c.cpp
//Project:	CIS023_S2018_Lab12c
//Author:	Allen Myers
//Date:		May 7th, 2018
//Purpose:	Create a linked list of graphic objects.
//			Move multiple graphic objects based on a timer.

#include "stdafx.h"
#include "CIS023_S2018_Lab12c.h"
...
LinkedListClass* list;							//linked list full of stars
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_CIS023_S2018_LAB12C, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_CIS023_S2018_LAB12C));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_CIS023_S2018_LAB12C));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_CIS023_S2018_LAB12C);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_TIMER:
		...
		{
			list->First();							//start at top of list
