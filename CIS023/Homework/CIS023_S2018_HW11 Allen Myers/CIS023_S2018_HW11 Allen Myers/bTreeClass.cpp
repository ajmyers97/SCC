...
//perform a sort on the btree, and output the values for node traversal
		//is the number to the left greater than?
		//is the number to the right greater than?
		//is the number to the left less than?
		//is the number to the right less than?

string bTreeClass::Sort(string strSearch)
{
